...
const ContentPage = () => {
	const [sakura, setSakura] = useState(null);

	useEffect(() => {
		if(sakura) return;
		!sakura && setSakura(new Sakura("#contentPage", {minSize: 5, maxSize: 10}));
	}, []);

	return (
		<Page id="contentPage" name="content">
			...
			<Block className="text-center md:mt-36">
				...
				<p className="my-3">
					...
					⏰ Time: Sunset <br />
					🏰 Venue: <Link href="https://maps.app.goo.gl/fJvMymdnyCsXVFVh8" external target="_blank">Karunamoyee Kali Temple 📍</Link> 
				</p>
				<p className="my-3 text-lg">Reception</p>
				<p className="my-3">
					📆 Date: 25th November <br />
					⏰ Time: Sunset <br />
					🏰 Venue: <Link href="https://goo.gl/maps/eyuGjtWzxHpSeCof8" external target="_blank">Home📍</Link> 
				</p>
				<p className="my-3">
